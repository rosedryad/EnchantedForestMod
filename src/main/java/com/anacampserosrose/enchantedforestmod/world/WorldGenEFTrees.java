package com.anacampserosrose.enchantedforestmod.world;
...
public class WorldGenEFTrees implements IWorldGenerator
	{
		private final WorldGenerator IVY = new WorldGenIvyTree();
		private final WorldGenerator PURPLE_WISTERIA = new WorldGenPurpleWisteriaTree(true);
		...
		public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
		{
			...
			case 0:
				...
				runGenerator(IVY, world, random, chunkX, chunkZ, 3, -1, 0, BiomeForest.class);
				runGenerator(PURPLE_WISTERIA, world, random, chunkX, chunkZ, 3, -1, 0, BiomeMagic.class, BiomePlains.class);
